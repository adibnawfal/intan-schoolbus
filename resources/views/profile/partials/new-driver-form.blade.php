<form method="post" action="{{ route('profile.post-new-driver') }}" class="flex flex-col gap-y-4">
  ...
  <div class="flex flex-col w-full">
    ...
    <p class="text-sm leading-relaxed lg:w-2/3">Please insert driver's personal details.</p>
  </div>
  ...
  <div class="flex flex-col w-full mt-8">
    ...
    <p class="text-sm leading-relaxed lg:w-2/3">Please insert driver's personal emergency contact person details.</p>
  </div>
  <div class="flex flex-wrap -m-2">
    <div class="w-1/2 p-2">
  ...
  <div class="flex flex-col w-full mt-8">
    ...
    <p class="text-sm leading-relaxed lg:w-2/3">Please insert driver's license details.</p>
  </div>
  <div class="flex flex-wrap -m-2">
    <div class="w-1/2 p-2">
  ...
  <div class="flex flex-col w-full mt-8">
    ...
    <p class="text-sm leading-relaxed lg:w-2/3">Please insert driver's email and password for driver's login purpose.
    </p>
  </div>
  <div class="flex flex-wrap -m-2">
