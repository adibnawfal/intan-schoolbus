...
<div class="flex flex-wrap -m-2">
  <div class="w-1/2 p-2">
    <label for="license" class="text-sm leading-7">License</label>
  ...
  <div class="w-1/2 p-2">
    <label for="validity" class="text-sm leading-7">Validity</label>
...
<div class="flex flex-wrap -m-2">
  ...
  <div class="w-1/2 p-2">
    <label for="new-password" class="text-sm leading-7">Password</label>
    <input type="password" id="new-password" name="new-password"
      class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
  </div>
  <div class="w-1/2 p-2">
    <label for="re-type-password" class="text-sm leading-7">Re-type Password</label>
