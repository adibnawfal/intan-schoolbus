<form method="post" action="{{ route('profile.delete-student', $studentData->id) }}">
  @csrf
  @method('delete')

  <div id="hs-delete-student-{{ $studentData->id }}-modal"
    ...
    <div
      ...
      <div
        ...
        <div class="relative flex flex-col h-full p-6 overflow-hidden rounded">
          ...
          <div class="w-full">
            <p>Are you sure you want to delete {{ $studentData->first_name }} {{ $studentData->last_name }} student?</p>
          </div>
          <button type="submit"
