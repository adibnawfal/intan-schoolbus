<form method="post" action="{{ route('profile.delete-driver', $driverDetailsData->user_id) }}">
  @csrf
  @method('delete')

  <div id="hs-delete-driver-{{ $driverDetailsData->user_id }}-modal"
    ...
    <div
      ...
      <div
        ...
        <div class="relative flex flex-col h-full p-6 overflow-hidden rounded">
          ...
          <div class="w-full">
            <p>Are you sure you want to delete {{ $driverDetailsData->first_name }} {{ $driverDetailsData->last_name }}
              driver?</p>
          </div>
          <button type="submit"
