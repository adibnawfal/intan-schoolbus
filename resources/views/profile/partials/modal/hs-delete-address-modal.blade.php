<form method="post" action="{{ route('profile.delete-address', $addressData->id) }}">
  @csrf
  @method('delete')

  <div id="hs-delete-address-{{ $addressData->id }}-modal"
    ...
    <div
      ...
      <div
        ...
        <div class="relative flex flex-col h-full p-6 overflow-hidden rounded">
          ...
          <div class="w-full">
            <p>Are you sure you want to delete {{ $addressData->address_1 }} address?</p>
          </div>
          <button type="submit"
