  ...
  <div
    ...
    <div
      ...
      <div class="relative flex flex-col h-full p-6 overflow-hidden rounded">
        <span
          class="absolute top-0 right-0 px-3 py-1 text-xs tracking-widest text-white bg-[#08183A] rounded-bl">{{ $parentGuardianData->status }}</span>
        ...
        @if (Auth::user()->role === 'customer')
          <div class="flex items-center mt-6 gap-x-2">
            ...
            <button type="button"
              ...
              data-hs-overlay="#hs-delete-parent-guardian-{{ $parentGuardianData->id }}-modal">
...
@include('profile.partials.modal.hs-delete-parent-guardian-modal')
