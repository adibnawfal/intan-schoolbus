  ...
  <div class="flex flex-col items-end justify-center w-full basis-1/2">
    <div class="max-w-[41rem] w-full pr-[15rem]  py-20">
      <div class="text-center">
        <h1 class="block text-3xl font-bold text-gray-800 dark:text-white">Sign Up</h1>
      </div>
      ...
      <div class="mt-6">
        ...
        <form method="post" action="{{ route('register') }}">
          ...
          <div class="grid gap-y-4">
            ...
            <!-- Confirm Password -->
            <div>
              <label for="password_confirmation" class="block mb-2 text-sm dark:text-white">Re-type Password</label>
              <div class="relative">
            ...
            <div class="flex flex-col justify-center">
              <div class="flex items-center">
                ...
                <label for="terms_and_conditions" class="text-sm ms-3 dark:text-white">I accept the <a
