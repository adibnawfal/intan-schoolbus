  ...
  <div class="flex flex-col items-end justify-center w-full basis-1/2 bg-[#08183A]">
    <div class="max-w-[41rem] w-full pr-[15rem]">
      <div class="text-center">
        <h1 class="block text-3xl font-bold text-[#F2BA1D] dark:text-white">Reset Password</h1>
      </div>
      ...
      <div class="mt-6">
        ...
        <form method="post" action="{{ route('password.store') }}">
          ...
          <div class="grid gap-y-4">
            ...
            <!-- Submit -->
            <button type="submit"
              class="inline-flex items-center justify-center w-full px-4 py-3 mt-3 text-sm font-semibold text-[#08183A] bg-[#F2BA1D] border border-transparent rounded-lg gap-x-2 hover:bg-[#F2BA1D]/[.8] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Reset
              Password</button>
            <!-- End Submit -->
          </div>
        </form>
