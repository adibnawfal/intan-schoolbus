    ...
    <form method="post" action="{{ route('transportation.patch-update-school', $schoolData->id) }}">
      ...
      <div class="flex flex-col p-4 bg-white shadow sm:p-8 sm:rounded gap-y-4">
        <div class="flex flex-col w-full">
          ...
          <p class="text-sm leading-relaxed lg:w-2/3">Please update school bus informations here.</p>
        </div>
        ...
        <div class="flex flex-col w-full mt-4">
          ...
          <p class="text-sm leading-relaxed lg:w-2/3">Please update the fee for each areas covered by the school bus
            service.</p>
        </div>
        <div class="flex flex-wrap -m-2">
          <div class="w-1/2 p-2">
