  ...
  <div class="flex flex-col w-full px-6 py-8 gap-y-6">
    <div class="flex flex-col p-4 bg-white shadow sm:p-8 sm:rounded gap-y-4">
      <div class="flex flex-col w-full">
        <h1 class="text-xl font-bold">Evening Session</h1>
        <p class="text-sm leading-relaxed">Below are the details of current students using school bus service for evening
          session only.</p>
      </div>
