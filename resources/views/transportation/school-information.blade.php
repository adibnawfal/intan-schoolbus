  ...
  <div class="flex flex-col w-full px-6 py-8 gap-y-6">
    <div class="flex flex-col p-4 bg-white shadow sm:p-8 sm:rounded gap-y-4">
      <div class="flex flex-col w-full">
        ...
        <p class="text-sm leading-relaxed lg:w-2/3">Manage or add school details here.</p>
      </div>
...
@if (session('status') === 'school-deleted')
    ...
    <div>
      <div class="p-4 rounded border-green-500 bg-green-50 border-s-4 role="alert">
        <div class="flex text-green-500">
          ...
          <div class="ms-3">
            <p class="text-sm">School has been successfully deleted.</p>
          </div>
          <div class="flex ms-8">
            <button type="button"
