<x-app-layout>
  ...
  <div class="flex flex-col w-full px-6 py-8 gap-y-6">
    <form method="post" action="{{ route('transportation.post-new-school') }}">
      @csrf
        ...
        <div class="flex flex-wrap -m-2">
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="flex w-full rounded-lg shadow-sm">
              <input type="number" id="service_period" name="service_period" value="{{ old('service_period') }}"
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="relative">
              <select id="standard" name="standard"
                class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
                <option @selected(old('standard') == 0) value=0 disabled>Select maximum standard</option>
        ...
        <div class="flex flex-wrap -m-2">
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="flex w-full rounded-lg shadow-sm">
              ...
              <input type="number" id="price1" name="price1" value="{{ old('price1') }}"
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="flex w-full rounded-lg shadow-sm">
              <span
                class="inline-flex items-center px-4 text-sm bg-gray-100 bg-opacity-50 border border-gray-300 min-w-fit rounded-s border-e-0">RM</span>
              <input type="number" id="price2" name="price2" value="{{ old('price2') }}"
                class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 outline-none rounded-e focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
            </div>
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="flex w-full rounded-lg shadow-sm">
              <span
                class="inline-flex items-center px-4 text-sm bg-gray-100 bg-opacity-50 border border-gray-300 min-w-fit rounded-s border-e-0">RM</span>
              <input type="number" id="price3" name="price3" value="{{ old('price3') }}"
                class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 outline-none rounded-e focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
            </div>
          ...
          <div class="w-1/2 p-2">
            ...
            <div class="flex w-full rounded-lg shadow-sm">
              <span
                class="inline-flex items-center px-4 text-sm bg-gray-100 bg-opacity-50 border border-gray-300 min-w-fit rounded-s border-e-0">RM</span>
              <input type="number" id="price4" name="price4" value="{{ old('price4') }}"
                class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 outline-none rounded-e focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
            </div>
