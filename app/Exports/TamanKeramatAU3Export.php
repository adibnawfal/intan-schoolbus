...
class TamanKeramatAU3Export implements FromCollection, WithHeadings, WithMapping
{
  /**
  ...
  {
    $pickupAddressId = Address::where('area', 'Taman Keramat AU3')->pluck('id');
    $dropoffAddressId = Address::where('area', 'Taman Keramat AU3')->pluck('id');
