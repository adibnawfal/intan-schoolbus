...
class TamanKeramatAU1Export implements FromCollection, WithHeadings, WithMapping
{
  /**
  ...
  {
    $pickupAddressId = Address::where('area', 'Taman Keramat AU1')->pluck('id');
    $dropoffAddressId = Address::where('area', 'Taman Keramat AU1')->pluck('id');
