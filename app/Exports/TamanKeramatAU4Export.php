...
class TamanKeramatAU4Export implements FromCollection, WithHeadings, WithMapping
{
  /**
  ...
  {
    $pickupAddressId = Address::where('area', 'Taman Keramat AU4')->pluck('id');
    $dropoffAddressId = Address::where('area', 'Taman Keramat AU4')->pluck('id');
